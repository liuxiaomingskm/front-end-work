...
// preprocessing the data
  ...
  {
    // data返回格式为 Data [Array(218), Array(218), Array(218), Array(218), Array(218)]
    /* 每个array中的元素形式如下
    {1960: null
1961: null
1962: null
...
indicator: "CO2 emissions (kt)"} */
    ...
    /* yearObj 格式如下 
    {1990: Array(152), 1991: Array(154), 1992: Array(175), 1993: Array(174), 
      1994: Array(175), 1995: Array(178), 1996: Array(177), 1997: Array(177)}
      每个Array中的元素形式如下
      {region: "Aruba", co2: 1730.824, methane: 15.1768, renewable: 0.198600563761172, 
      population: 62149, …} 
      formatAllData函数的作用就是讲data转化成yearObj*/
...
function formatter(row) {
  ...
  if (invalidRows.indexOf(obj.region) > -1) return; // 去除不要的地区行
  for (var key in row){
